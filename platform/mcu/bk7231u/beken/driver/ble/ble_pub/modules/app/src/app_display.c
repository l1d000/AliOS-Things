...
static void app_display_sec_tick_evt_hdl(void)
{
    ...
    kernel_event_clear(KERNEL_EVENT_RTC_1S_TICK);
...
{
    kernel_event_set(KERNEL_EVENT_RTC_1S_TICK);
}
#endif // RTC_SUPPORT
...
//    display_screen_set(s_db_size, &app_display_hdl_db_size, "< DB HEAP SIZE", "  0x0000/0x0000");
    ...
    kernel_event_callback_set(KERNEL_EVENT_RTC_1S_TICK, &app_display_sec_tick_evt_hdl);
