...
#include "application.h"                     // Application Manager Definitions
 ...
 ****************************************************************************************
 */
static int diss_value_req_ind_handler(kernel_msg_id_t const msgid,
                                          ...
                                          kernel_task_id_t const src_id)
{
    ...
    struct diss_value_cfm *cfm_value = KERNEL_MSG_ALLOC_DYN(DISS_VALUE_CFM,
            src_id, dest_id,
            diss_value_cfm,
            len);
...
const struct kernel_msg_handler app_dis_msg_handler_list[] =
{
    {DISS_VALUE_REQ_IND,     (kernel_msg_func_t)diss_value_req_ind_handler},
};

const struct kernel_state_handler app_dis_table_handler =
    {&app_dis_msg_handler_list[0], (sizeof(app_dis_msg_handler_list)/sizeof(struct kernel_msg_handler))};
