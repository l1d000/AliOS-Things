...
static int bass_batt_level_ntf_cfg_ind_handler(kernel_msg_id_t const msgid,
...
static int batt_level_upd_handler(kernel_msg_id_t const msgid,
...
static int bass_enable_rsp_handler(kernel_msg_id_t const msgid,
 ...
 ****************************************************************************************
 */
static int app_batt_msg_dflt_handler(kernel_msg_id_t const msgid,
                                     void const *param,
                                     kernel_task_id_t const dest_id,
                                     kernel_task_id_t const src_id)
{
...
const struct kernel_msg_handler app_batt_msg_handler_list[] =
{
    // Note: first message is latest message checked by kernel so default is put on top.
    {KERNEL_MSG_DEFAULT_HANDLER,        (kernel_msg_func_t)app_batt_msg_dflt_handler},
    {BASS_BATT_LEVEL_NTF_CFG_IND,   (kernel_msg_func_t)bass_batt_level_ntf_cfg_ind_handler},
    {BASS_BATT_LEVEL_UPD_RSP,       (kernel_msg_func_t)batt_level_upd_handler},
		{BASS_ENABLE_RSP,       				(kernel_msg_func_t)bass_enable_rsp_handler},
		
};

const struct kernel_state_handler app_batt_table_handler =
    {&app_batt_msg_handler_list[0], (sizeof(app_batt_msg_handler_list)/sizeof(struct kernel_msg_handler))};
